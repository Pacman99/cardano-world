  ...
  in
  {
    options = {
      packagesExes = lib.mkOption {
        ...
        default = import ./packages-exes.nix;
        description = "Pre-computed local project package list (generated by nix/regenerate.sh) to avoid double evaluation";
      };
    };
    config = {
      name = "cardano-node";
